...
| [B站自定义播放页](scripts/bilibili-custom-play-page.js) | bilibili.com 视频播放页 | 新版播放页定制脚本：云端时间窗口、右侧推荐、结束页推荐、UP屏蔽、推荐缓存、禁用迷你播放器 |
...
`scripts/bilibili-custom-play-page.js` 支持读取 Gitee 原始 JSON 控制播放时间窗口、推荐 UP 主和屏蔽 UP 主：
